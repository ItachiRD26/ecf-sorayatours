          ...
          onSelect={(s, modo) => {
            ...
            setItems((prev) => {
              const updated = prev.map((item, idx) =>
                idx === showServicios
                  ? { ...item, servicioId: s.id, fromCatalog: true, codigo: s.codigo, descripcion: s.nombre, modo: tier.modoResultante, precio: tier.precio, tramoLabel: tier.tramoLabel, itbis: s.itbis, incluyeITBIS: s.incluyeITBIS ?? false, cant: 1, pax }
                  : item
              );
